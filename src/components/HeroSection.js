    ...
    >
      <div className="flex justify-center items-center">
        <div className="flex flex-col mt-10 sm:mt-20 items-center">
          ...
          <span className="text-white text-5xl absolute top-32 sm:text-5xl sm:mt-8 text-center">
            Access Innovative <br />
            Healthcare
          </span>
          <span className="text-white text-sm sm:text-base top-64 sm:mt-4 contrast-75 text-center absolute">
            Empowering primary care professionals to seamlessly identify and
            engage <br /> with eligible patients for clinical trial
            opportunities.
          </span>
          <button className="bg-white text-[#392B85] text-sm sm:text-base mt-4 sm:mt-8 px-6 sm:px-8 py-3 sm:py-4 text-center rounded absolute top-80">
            Contact Us
          </button>
        </div>
      </div>
